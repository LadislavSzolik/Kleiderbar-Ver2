...
class ListOfCategoriesTableViewController: UITableViewController {
    
    var selectedCategory : ClothesCategory?
    ...
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        selectedCategory = ClothesCategory.all[indexPath.row]
        performSegue(withIdentifier: "SelectClothesCategory", sender: self)
    }
